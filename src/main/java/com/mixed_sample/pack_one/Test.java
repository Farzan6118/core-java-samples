...
public class Test {
    ...
    BiConsumer<Integer, Integer> print = (s, s2) -> System.out.println(s + s2);
    ...
    public void printTheResult() {
        ...
        List<Integer> integerList = StreamSupport.stream(Spliterators.spliteratorUnknownSize(stringListIterator, Spliterator.ORDERED), false).map(String::length).collect(Collectors.toList());
